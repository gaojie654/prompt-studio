...
2. **AI 工作台（4模块）**
   - 🎨 **文字生图片** - Kwai-Kolors/Kolors 文生图
   - 🖼️ **参考图生图片** - Qwen/Qwen-Image-Edit 以图生图（基于参考图生成）
   - 🎬 **文字生视频** - Wan-AI/Wan2.2-T2V-A14B（即将上线）
   - 🎥 **图+文生视频**（即将上线）
3. **多平台适配** - 支持淘宝/抖音/小红书/京东/拼多多/公众号
4. **会员与积分** - PRO 会员 / 余额充值 / 无水印下载（20积分）
...
- **图片生成**: SiliconFlow (Kwai-Kolors/Kolors 文生图 / Qwen/Qwen-Image-Edit 以图生图)
